...
all:
	...
	@ gcc -ffreestanding -m64 -O0 -mno-red-zone -mabi=ms -c ./source/kernel/lib/src/interrupt/pic_IO_in.s -o ./build/pic_IO_in.o
	@ gcc -ffreestanding -m64 -O0 -mno-red-zone -mabi=ms -c ./source/kernel/lib/src/interrupt/pic_IO_out.s -o ./build/pic_IO_out.o
	...
	@ gcc -ffreestanding -m64 -O0 -mno-red-zone -mabi=ms -c ./source/kernel/lib/src/interrupt/EOI_IO_out.s -o ./build/EOI_IO_out.o
